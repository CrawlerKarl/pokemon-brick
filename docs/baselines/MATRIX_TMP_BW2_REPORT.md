# CAMPAIGN MATRIX — TMP-BW2

Generated 2026-07-25T01:42:44.344Z at `440b41960a` by `npm run baseline -- --label tmp-bw2`.
Deterministic fixtures: seeded `DEV.launch` + a state-derived autopilot stepping `update(1/60)`.
Full per-scenario `DEV.report()` payloads: `docs/baselines/matrix-tmp-bw2.json`.
...
| L21 | blaster | yes | 53.5s | 1.19 | 1366.4 | 0 | 5 |
| L21 | blaster | yes | 66.8s | 1.19 | 1311.1 | 0 | 5 |
| L21 | blaster | yes | 39.5s | 1.19 | 1376.2 | 0 | 5 |

## BUDGETS (AFT-021 — the approved bands)

**RED — 2 hard violation(s):**
- ✗ L3-blaster: mean 50.7s outside [55,120] (63.6/40.6/50.7)
- ✗ L21-blaster: mean 53.5s outside [55,120] (53.5/66.8/39.5)
