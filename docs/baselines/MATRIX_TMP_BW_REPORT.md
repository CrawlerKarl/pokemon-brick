# CAMPAIGN MATRIX — TMP-BW

Generated 2026-07-25T01:42:25.276Z at `440b41960a` by `npm run baseline -- --label tmp-bw`.
Deterministic fixtures: seeded `DEV.launch` + a state-derived autopilot stepping `update(1/60)`.
Full per-scenario `DEV.report()` payloads: `docs/baselines/matrix-tmp-bw.json`.
...
| L21 | blaster | yes | 47.0s | 1.18 | 1252.0 | 0 | 5 |
| L21 | blaster | yes | 51.6s | 1.18 | 1247.3 | 0 | 5 |
| L21 | blaster | yes | 55.6s | 1.18 | 1201.6 | 0 | 5 |

## BUDGETS (AFT-021 — the approved bands)

**RED — 2 hard violation(s):**
- ✗ L3-blaster: mean 50.7s outside [55,120] (63.6/40.6/50.7)
- ✗ L21-blaster: mean 51.6s outside [55,120] (47.0/51.6/55.6)
